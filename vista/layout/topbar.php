...
<head>
    ...
    <head lang="es">
        ...
        <title>Registro de asistencias-php</title>
        ...
        <script src="https://kit.fontawesome.com/dce04afcce.js" crossorigin="anonymous"></script>
                        ...
                        <div class="site-header-shown">
                            ...
                            <div class="dropdown user-menu">
                                ...
                                <div class="dropdown-menu dropdown-menu-right pt-0" aria-labelledby="dd-user-menu">
                                    ...
                                    <a class="dropdown-item" href="/sis-asistencia2/controlador/controlador_cerrar_sesion.php">
